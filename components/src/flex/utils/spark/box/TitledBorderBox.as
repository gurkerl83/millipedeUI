package flex.utils.spark.box {
	...
	public class TitledBorderBox extends SkinnableContainer {
		...
		private static function classConstruct():Boolean {
			...
			var style:CSSStyleDeclaration = styleManager.getStyleDeclaration("flex.utils.spark.box.TitledBorderBox");
			if (!style) {
			...
			styleManager.setStyleDeclaration("flex.utils.spark.box.TitledBorderBox", style, true);
			return true;
		}
